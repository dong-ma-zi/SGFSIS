...
def main(args):
    ...
    # for shot in [1, 3, 5, 10, 20, 50]:
    for shot in [1, 3, 5, 10, 20, 50]:
        print(f'shot {shot}')
        save_dir = os.path.join(args.save_dir, 'ext_' + args.ext_dataset + '_tsk_' + args.tsk_dataset,
                                f'labeledShot_{shot}')
        # old_save_dir = os.path.join('./exp_bk_0828', args.dataset, f'labeledShot_{shot}')
        ...
        for run in range(1, 2): # draw results for the first run
            print(f'#####################################run_{run}##########################################')
            ...
            print('aji: {}, detection_f1 {}, pq {}, cls_f1: {}'.format(aji, F1_det,
                                                                             mpq, F1_avg))
        ...
        print('aji_mean_f1: {}'.format(multi_run_mean_f_score))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ext_dataset', type=str, default='monusac_20x',
                        help="dataset: lizard | pannuke | consep | monusac")
    parser.add_argument('--tsk_dataset', type=str, default='lizard',
                        help="dataset: lizard | pannuke | consep | monusac")
