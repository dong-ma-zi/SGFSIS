...
def main(args):
    ...
    assert args.full_sup == True
    save_dir = os.path.join(args.save_dir, 'ext_' + args.dataset)
    ...
    for run in range(1, num_run + 1):
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if epoch % args.epochs == 0 or epoch % 5 == 0:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='monusac_20x', help="dataset: lizard | pannuke")
    ...
    parser.add_argument('--shot', type=float, default=5, help="N-way K-shot")
    ...
    parser.add_argument('--train_root', type=str,
                        ...
                        default='/home/data1/my/dataset/monusac/extracted_mirror_20x/train/256x256_256x256/',
                        # default='/home/data1/my/dataset/pannuke/Fold_12/',
    ...
    parser.add_argument('--test_root', type=str,
                        ...
                        default='/home/data1/my/dataset/monusac/extracted_mirror_20x/test/256x256_256x256/',
                        # default='/home/data1/my/dataset/pannuke/Fold_3/',
