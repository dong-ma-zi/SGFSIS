...
def model_init():
    frozen_list = ['semantic_proto_bank', 'contour_proto_bank', 'centroid_proto_bank',
                   'cenp_guided_conv', 'conp_guided_conv']
...
def main_worker(argss):
    ...
    for run, (tsk_loader, tsk_loader_regis) in enumerate(zip(tsk_loader_list, tsk_loader_regis_list), start=4):
