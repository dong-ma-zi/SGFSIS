...
def get_parser():
    ...
    parser.add_argument('--config', type=str,
                        default='./config/ext_joint_training/monusac_20x.yaml',
                        help='config file')
...
def train_one_epoch(train_loader, model, optimizer, epoch, num_class):
    ...
    for i, (img_input, cls_target, fore_target, _,
        ...
        loss = loss + sem_meta_loss + cen_meta_loss + con_meta_loss

        # meta loss
        accu_loss["sup"]['cls_metabce'] += 0
