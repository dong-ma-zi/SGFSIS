"""
func: only with guidance prediction, without residual directly prediction
"""
...
loss_opts = {"np": {"bce": 0, "dice": 0},
             "conp": {"con_bce": 0, "con_dice": 0},
             "cenp": {"cen_mse": 0},
...
def main_worker(argss):
    ...
    optimizer = torch.optim.Adam(
        [{'params': model.backbone.parameters()},
         ...
         {'params': model.decoder['tp'].parameters()},
