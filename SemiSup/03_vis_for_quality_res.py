...
def main(args):
    ...
    # for shot in [1]:
        print(f'shot {shot}')
        save_dir = os.path.join(args.save_dir, args.dataset, f'labeledShot_{shot}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--visible_device', type=str, default="2", help="gpu can be visual")
    # parser.add_argument('--amp', type=bool, default=True, help="是否使用混合精度")
    parser.add_argument('--use_unlabeled', type=bool, default=False)
    parser.add_argument('--dataset', type=str, default='lizard', help="dataset: lizard | pannuke | consep | monusac")
    ...
    parser.add_argument('--shot', type=float, default=10, help="有标签与所有数据的比例")
