...
from utils.viz_utils import draw_overlay_scaling, draw_overlay_by_index, draw_overlay
import cv2
...
def evaluate_one_epoch_patch_level(model,
    ...
    for idx, result in enumerate(results):
        ...
        if is_draw and num_run == 1:
            ...
            # cv2.imwrite(
            #     f'/home/data1/my/dataset/lizard/vis_2_draw_overlay/{img_name}.png',
            #     overlay[crop_size: -crop_size, crop_size: -crop_size, :])
