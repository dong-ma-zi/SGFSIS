...
def evaluate_one_epoch_patch_level(model,
    ...
    for idx, result in enumerate(results):
        ...
        if is_draw and num_run == 1:
            ...
            # overlay = cv2.imread(f'/home/data1/my/dataset/monusac/extracted_mirror/test/256x256_256x256/overlay/{img_name}.png')
            # overlay = cv2.imread(
            #     f'/home/data1/my/dataset/consep/extracted_mirror/valid/256x256_256x256/overlay/{img_name}.png')
