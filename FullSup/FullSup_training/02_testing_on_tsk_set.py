...
if __name__ == '__main__':
    ...
    parser.add_argument('--visible_device', type=str, default="1", help="gpu can be visual")
    # parser.add_argument('--amp', type=bool, default=True, help="是否使用混合精度")
    parser.add_argument('--use_unlabeled', type=bool, default=False)
    parser.add_argument('--dataset', type=str, default='consep', help="dataset: lizard | pannuke | consep | monusac")
