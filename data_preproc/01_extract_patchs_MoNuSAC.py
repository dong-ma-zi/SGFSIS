...
if __name__ == "__main__":
    ...
    win_size = [256, 256]
    step_size = [256, 256] # 128 for consep 256 for monusac
    ...
    save_root = f"/home/data1/my/dataset/{dataset_name}/extracted_{extract_type}_20x"

    # a dictionary to specify where the dataset path should be
    dataset_info = {
        "train": {
            "img": (".png", f"/home/data1/my/dataset/{dataset_name}/Train/Images/"),
            "ann": (".mat", f"/home/data1/my/dataset/{dataset_name}/Train/Labels/"),
        },
        "test": {
            "img": (".png", f"/home/data1/my/dataset/{dataset_name}/Test/Images/"),
            "ann": (".mat", f"/home/data1/my/dataset/{dataset_name}/Test/Labels/"),
        },
    }
